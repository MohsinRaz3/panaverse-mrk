...
export default function Page() {
    ...
    return (
        <>        <Box >
            <Container maxW={1400} bgAttachment='fixed' bgImage={"https://e0.pxfuel.com/wallpapers/112/218/desktop-wallpaper-abstract-background-light-grid-light-coloured-grey.jpg"}>
                <Flex display={{ lg: 'flex', base: 'grid' }} pb='100px' px='10px' pt={{ lg: '50px', base: '0px' }} >
                    <Box px={{ lg: '40px', base: '0px' }} pt={{ lg: '200px', base: '50px' }}>
                        ...
                        <Text color='whiteAlpha.900' py='20px'>Getting Ready for the Next Generation and Future of the Internet - Join a 13 Trillion Dollar Industry with 5 Billion Users. A Nationwide Program in Karachi, Lahore, Islamabad, and Peshawar</Text>
            ...
            <Box >
                <Box  >
                    <Flex my={["12", "60"]} flexDir={["column-reverse", "row"]} mx='auto' maxW='90%' align="center" justifyContent="center">
                        <Box w="50%" mt={["12", "0"]}>
